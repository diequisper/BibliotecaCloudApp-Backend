...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("server=.;database=db_biblioteca;integrated security=true;TrustServerCertificate=true");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Autor>(entity =>
        {
            entity.HasKey(e => e.IdAutor).HasName("PK__autor__5FC3872D2B5808D6");
            ...
            entity.Property(e => e.FechaDeceso).HasColumnName("fecha_deceso");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__autor_bo__3213E83FDE58295E");
            ...
            entity.HasOne(d => d.AutorNavigation).WithMany(p => p.AutorBookmarks)
                .HasForeignKey(d => d.Autor)
                .HasConstraintName("FK__autor_boo__autor__4F7CD00D");

            entity.HasOne(d => d.UsuarioNavigation).WithMany(p => p.AutorBookmarks)
        ...
        {
            entity.HasKey(e => e.IdEditorial).HasName("PK__editoria__10C1DD02DA018ECE");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__editoria__3213E83FC7F15233");
            ...
            entity.HasOne(d => d.EditorialNavigation).WithMany(p => p.EditorialBookmarks)
                .HasForeignKey(d => d.Editorial)
                .HasConstraintName("FK__editorial__edito__571DF1D5");

            entity.HasOne(d => d.UsuarioNavigation).WithMany(p => p.EditorialBookmarks)
                .HasForeignKey(d => d.Usuario)
        ...
        {
            entity.HasKey(e => e.IdLibro).HasName("PK__libro__EC09C24E74EC9A0B");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__libro_bo__3213E83FF5A779B7");
            ...
            entity.HasOne(d => d.LibroNavigation).WithMany(p => p.LibroBookmarks)
                .HasForeignKey(d => d.Libro)
                .HasConstraintName("FK__libro_boo__libro__534D60F1");

            entity.HasOne(d => d.UsuarioNavigation).WithMany(p => p.LibroBookmarks)
                .HasForeignKey(d => d.Usuario)
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__usuario__3213E83FEF7ECB4C");

            entity.ToTable("usuario");

            entity.HasIndex(e => e.Username, "UQ__usuario__F3DBC57203851CA0").IsUnique();

            entity.HasIndex(e => new { e.Nombre, e.Apellido }, "uq_nom_ap").IsUnique();
